...
class RegisterBuyer extends Component {
    ...
    render() {
                ...
                <div className="bodyC">
                    <div className="img-wrapper">
                        ...
                        <div className="wine-text-container">
                            <div className="site-title wood-text">Loading...</div>
                        </div>
                    </div>
        ...
        return (
            <div className="bodyC" style={{backgroundColor:'black'}}>
                <div style={{marginTop:'5.5rem'}} className="img-wrapper">
                {/* <img src="https://image.shutterstock.com/image-illustration/blockchain-digital-chain-blocks-connection-600w-704533387.jpg" className="logo" />
                    <div className="wine-text-container">
                        <div className="site-title" style={{backgroundColor:'black'}}>Land Registry</div>
                    </div> */}
                </div>
                <div className="auth-wrapper">
                    <div className="auth-inner">
