            ...
            return (
                ...
                <div className="bodyC">
                    <div className="img-wrapper">
                        <img src="https://image.shutterstock.com/image-illustration/blockchain-digital-chain-blocks-connection-600w-704533387.jpg" className="logo" />
                        <div className="wine-text-container">
                            <div className="site-title wood-text">Land Record Management System</div>
                        </div>
                    </div>
                    <div className="auth-wrapper">
                        <div className="auth-inner">
                            <h2 style={{marginBottom:'2rem'}}>You are already registered.</h2>
                            <Button href="/Seller/SellerDashboard" disabled={!this.state.seller} className="btn-block" style={{ margin: "2px", backgroundColor: "tomato" }} >Seller Dashboard</Button>
                            <br /><Button href="/admin/dashboard" disabled={!this.state.buyer} className="btn-block" style={{ margin: "2px", backgroundColor: "green" }}>Buyer Dashboard</Button>
                ...
                <div className="auth-wrapper">
                    <div className="auth-inner">
                        <div>
                            ...
                            <h4 style={{ letterSpacing: "2px", color: 'black' }}>Secure and Decentralised Land Management System!</h4>
                            <hr
                                style={{
                                    color: "#696969",
                                    height: 1
